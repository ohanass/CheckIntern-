...
class Usuario : public Aluno{
    ...
    // @brief Construtor da classe Usuario, derivada da classe Aluno.
    ...
    // @brief Atualiza o currículo do usuário.
    // @param curriculo Ponteiro para um objeto Curriculo a ser utilizado como novo currículo.
    ...
    // @brief Envia o currículo do usuário.
    void enviar_curriculo(void);
